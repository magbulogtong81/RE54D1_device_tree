...
include $(CLEAR_VARS)
LOCAL_MODULE       := init.recovery.RMX3265.rc
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := etc/init.recovery.RMX3265.rc
...
include $(CLEAR_VARS)
LOCAL_MODULE       := ueventd.RMX3265.rc
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := etc/ueventd.RMX3265.rc
LOCAL_MODULE_PATH  := $(TARGET_ROOT_OUT)
include $(BUILD_PREBUILT)
